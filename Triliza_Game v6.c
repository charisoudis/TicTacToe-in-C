/**
 * TRILIZA GAME
 * CREATOR: THANASIS CHARISOUDIS <thanasis@charisoudis.gr>
 */
...
int main()    //OK!
{
    ...
    clock_t t; //time
    int durs = 8, wait1 = 2, d, ti, i, pc_starts[50] = {
            0}, pc_st, swich = 0, game2, j, game_choice, null, null0, num, pc_num, numb[3][3], win, pl_win_pc, pl_win_pl, pl_draw, pl_games, a, pl_side, moves_pl[80], moves_pc[80], res[80], point, name_len, pl_gaps, min, sec, secg[80], ming[80], sum_min, sum_sec, sum_moves, best_game, worst_game, max, posi, posj;
    ...
    char c_board[3][3], f_ans, ans1[80], playground[3][3], name[80], name1[27], name2[27], choice[80], side, pc_side, anal, nums[10], game_pic[50][9], start[50][27] = {
            32}, pll_side, pl_pc_side, pl_1[27], pl_2[27];
    float p;
    ...
    while (f_ans == 'y' || f_ans == 'Y') {
        ...
        if (pl_games == 1) {
            ...
            if (game_choice == 2)
                ...
                printf("\n\nOk, %s, you are '%c'. Therefore, i am '%c'.\n\nHere's the playground\n", name, side,
                       pc_side);
            printf("\n %c | %c | %c \n-----------\n %c | %c | %c \n-----------\n %c | %c | %c \n", playground[0][0],
                   playground[0][1], playground[0][2], playground[1][0], playground[1][1], playground[1][2],
                   playground[2][0], playground[2][1], playground[2][2]);

            printf("\nEvery cell points to a number (1-9):\n");
            printf("\n %c | %c | %c \n-----------\n %c | %c | %c \n-----------\n %c | %c | %c \n", c_board[0][0],
                   c_board[0][1], c_board[0][2], c_board[1][0], c_board[1][1], c_board[1][2], c_board[2][0],
            ...
            if (game_choice == 2) {
                ...
                printf("\n\nOk, %s & %s.\n\nHere's the playground (%s is '%c' & %s is '%c', as before): \n", name1,
                       name2, name1, side, name2, pc_side);
            } else {
        ...
        while (i < pc_st && (con_win)) {
            ...
            } else {    //checking in case pc starts
            ...
            while (con_num && !not_first && cn)  //not first is true if pc starts
            {
                ...
                if (i == 1) {
                    ...
                    if (game_choice == 2) {
                        printf("\n      %c | %c | %c \n     -----------  %s, you are %c.\n      %c | %c | %c     \n     -----------  %s, you are %c.\n      %c | %c | %c \n",
                               c_board[0][0], c_board[0][1], c_board[0][2], name1, side, c_board[1][0], c_board[1][1],
                               c_board[1][2], name2, pc_side, c_board[2][0], c_board[2][1], c_board[2][2]);
                        printf("\n\n%s, choose a number in order to get started: ", name1);
                    } else {
                        printf("\n      %c | %c | %c \n     -----------\n      %c | %c | %c    %s, you are %c. \n     -----------\n      %c | %c | %c \n",
                               c_board[0][0], c_board[0][1], c_board[0][2], c_board[1][0], c_board[1][1], c_board[1][2],
                               name, side, c_board[2][0], c_board[2][1], c_board[2][2]);
                ...
                if (num >= 1 && num <= 9) {
                    ...
                    if (num != 3 && num != 6 && num != 9) {
                        // For nums s.t.: num%3=0 i has to take a separate condition so that the match between num & numb[] is correct
                    ...
                    if (EMPTY)
                        ...
                        printf("\n      %c | %c | %c \n     -----------\n      %c | %c | %c \n     -----------\n      %c | %c | %c \n",
                               c_board[0][0], c_board[0][1], c_board[0][2], c_board[1][0], c_board[1][1], c_board[1][2],
                               c_board[2][0], c_board[2][1], c_board[2][2]);

                    }
                } else {
                    if (i == 1) CLEAR_COMMAND   //Fixing print error only in first loop
            ...
            if (i == 5 && game_choice != 2) {
                ...
                printf("\n      %c | %c | %c \n     -----------    %c ---> %s\n      %c | %c | %c \n     -----------    %c ---> %s\n      %c | %c | %c \n",
                       playground[0][0], playground[0][1], playground[0][2], side, name1, playground[1][0],
                       playground[1][1], playground[1][2], pc_side, name2, playground[2][0], playground[2][1],
                       playground[2][2]);
                    ...
                    while (con_num) {
                        ...
                        if (num >= 1 && num <= 9) {
                            ...
                            if (EMPTY)
                                ...
                                printf("\nHere are the remaining numbers-cells:\n");
                                printf("\n      %c | %c | %c \n     -----------\n      %c | %c | %c \n     -----------\n      %c | %c | %c \n",
                                       c_board[0][0], c_board[0][1], c_board[0][2], c_board[1][0], c_board[1][1],
                                       c_board[1][2], c_board[2][0], c_board[2][1], c_board[2][2]);
                            }
                        } else printf("\nYou can only choose a number between 1 and 9\n");
                    }
                    pc_num = num;
            ...
            if (i < pc_st - 1) {
                ...
                if (pc_num <= 3) {
                    ...
                    c_board[0][pc_num -
                               1] = ' ';     // Deleting the number, the cell that it points to, has been chosen
                } else if (pc_num <= 6) {
                    numb[1][pc_num - 4] = -1;
        ...
        if (f_ans == 'y' || f_ans == 'Y') {
            ...
            } else if (anal != 27 && game_choice ==
                                     2)  //in player vs player mode: best game is name1 best game - worst game==name2 best game
            {
                    ...
                    if (res[i] == 0) {
                        if (game_choice == 1) {
                            printf("  |         %d      |        %d       |      %d     |  %02d:%02d  |   Draw         |\n",
                                   i + 1, moves_pl[i], moves_pc[i], ming[i], secg[i]);
                            wait(33);
                        } else {
                            printf("  |         %d      |       %d      |       %d      |  %02d:%02d  |   Draw         |\n",
                                   i + 1, moves_pl[i], moves_pc[i], ming[i], secg[i]);
            ...
            if (pl_win_pl <= 9)
                printf(" ");                                                                                  //for correct show up
            printf("                       Total Games: %d", pl_games);
            if (pl_games <= 9) printf(" ");
            printf("        |\n");
            wait(33); //
            printf("  |                                                                         |\n");
            wait(33);
            ...
            wait(33);
            if (game_choice == 1) {
                printf("  |                    Your Best Game* : %d", best_game);
                if (best_game <= 9) printf(" ");
                printf("                                 |\n");
                wait(33);
            }  //for correct show-up
            else {
                printf("  |                    Pl. 1 Best Game*: %d", best_game);
                if (best_game <= 9) printf(" ");
                printf("                                 |\n");
                wait(33);
            }  //for correct show-up
            if (game_choice == 1) {
                printf("  |                    Your Worst Game*: %d", worst_game);
                if (worst_game <= 9) printf(" ");
                printf("                                 |\n");
                wait(33);
            }//
            else {
                printf("  |                    Pl. 2 Best Game*: %d", worst_game);
                if (best_game <= 9) printf(" ");
                printf("                                 |\n");
                wait(33);
            }  //for correct show-up
...
void loading_fx(void) {
    ...
    for (int gaw = 0; gaw < wait_num; gaw++) {
        if (step == gaw) {
            ...
            for (int faw = 0; faw < law - 2; faw++) printf(" ");
            printf("%d", numm);  //percentage no
            law++;
            ...
            numm += 2;
            printf("\n              0");
            for (int faw = 0; faw < 23; faw++) printf(" ");
            printf("50");
            for (int faw = 0; faw < 23; faw++) printf(" ");
            printf("100\n\n\n\n");    //limits no.
...
int best_move(int (numb)[3][3]) //OK!
{
    ...
    if (numb[0][0] == 0 && numb[0][1] == -1 && numb[0][2] == 1 && numb[1][0] == 1 && numb[1][1] == -1 &&
        numb[1][2] == 0 && numb[2][0] == 0 && numb[2][1] == 1 && numb[2][2] == 0) {
        return (9);
    } else if (numb[0][0] == 1 && numb[0][1] == -1 && numb[0][2] == 0 && numb[1][0] == 0 && numb[1][1] == -1 &&
               numb[1][2] == 1 && numb[2][0] == 0 && numb[2][1] == 1 && numb[0][2] == 0) {
        return (7);
    } else if (numb[0][0] == -1 && numb[0][1] == 0 && numb[0][2] == 1 && numb[1][0] == 1 && numb[1][1] == 1 &&
               numb[1][2] == -1 && numb[2][0] == -1 && numb[2][1] == 0 && numb[0][2] == 1)  //Bug Fix
    {
        return (2);
    }
        //pc winning mode
